...
classifier/train_secondary_model.py so the feature vector matches the model
artifacts in classifier/models/ exactly.
...
from classifier.rule_engine import build_rule_trace, compute_cape_cin
...
# ══════════════════════════════════════════════════════════════════════════════
# 5. FEATURE ENGINEERING (identical to classifier/train_secondary_model.py)
# ══════════════════════════════════════════════════════════════════════════════
